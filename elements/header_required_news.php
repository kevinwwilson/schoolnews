...
$akt = GetNewsInfoHelper::getInfo('kent-news-prod', 'primary_headline', $_GET['rID']);
$akt = strip_tags($akt);
$akd = GetNewsInfoHelper::getInfo('kent-news-prod', 'summary', $_GET['rID']);
$akd = strip_tags($akd);
...
$akt = preg_replace($search, $replace, $akt); 
$akd  = preg_replace($search, $replace, $akd); 





//removed default C5 tile and Meta_description functions
