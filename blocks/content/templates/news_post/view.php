...
//            document.write('<div id="placement_181293_'+plc181293+'"></div>');
        ...
        <div class="article-box-ad">
            ...
            <div id="box-ad2">
                ...
                var abkw = window.abkw || '';
                var absrc = 'https://servedbyadbutler.com/adserve/;ID=166541;size=300x250;setID=270632;type=js;sw='+screen.width+';sh='+screen.height+';spr='+window.devicePixelRatio+';kw='+abkw+';pid='+pid270632+';place='+(plc270632++)+';rnd='+rnd+';click=CLICK_MACRO_PLACEHOLDER';
                document.write('<scr'+'ipt src="'+absrc+'" type="text/javascript"></scr'+'ipt>');
                </script>
            </div>
        </div>
